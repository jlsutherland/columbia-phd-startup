...
output: 
  pdf_document:
    ...
    template: ./jls-tex-ms.tex
title: "Columbia PhD RMarkdown Manuscript Starter"
thanks: "You can thank people here, where you got comments at workshops, etc..."
author:
  name: Joseph L. Sutherland
  note: "Graduate Student, Department of Political Science, Columbia University, 7th Floor, IAB, 420 West 118th Street, Mail Code 3320, New York, NY 10018, USA."
  email: joseph.sutherland@columbia.edu
abstract: "This is forked from Steve Miller's tex templates. This document provides an introduction to R Markdown, argues for its benefits, and presents a sample manuscript template intended for an academic audience. I include basic syntax to R Markdown and a minimal working example of how the analysis itself can be conducted within R with the `knitr` package."
...
```{r, eval=FALSE, tidy = TRUE, cache=TRUE}
...
```{r, eval=TRUE, tidy = TRUE, cache=TRUE, fig.cap="A Coefficient Plot"}
suppressMessages(library(Zelig))
suppressMessages(library(arm))
...
```{r, eval=TRUE, tidy = TRUE, size="small", cache=TRUE, results="asis"}
suppressMessages(library(Zelig))
...
<!-- Cite your author keys here. I will just cite everything -->
\nocite{*}
